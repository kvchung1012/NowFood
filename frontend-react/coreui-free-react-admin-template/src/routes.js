import CategoryComponent from './views/nowfood/category/CategoryComponent'
import ProductComponent from './views/nowfood/product/ProductComponent'
import ShopCategoryComponent from './views/nowfood/shopcategory/ShopCategoryComponent'
...
const routes = [
  ...
  { path: '/category', name: 'Danh mục sản phẩm', component: CategoryComponent },
  { path: '/shop-category', name: 'Danh mục sản phẩm của shop', component: ShopCategoryComponent },
  { path: '/product', name: 'Sản phẩm', component: ProductComponent },
